...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
        <a href="home" class="navbar-brand">
            <img src="img/cb10.png" alt="cb-10 logo" width="140px"
                height="60px">
        </a>
    ...
    <div  id="regform" class="border border-info rounded bg-white p-5">
        <springForm:form action="doupdate" method="post" class="main-form" novalidate="true" modelAttribute="trainer">
                <springForm:input path="trainerId" type="hidden" />
        <div class="form-group">
            <label for="firstname">First Name</label>
                <springForm:input path="firstName" min="asd" name="firstname"  placeholder="First Name..." cssClass="form-control" id="firstname" cssErrorClass="form-control errorbox" maxlength="30" required="true"/>
        ...
        <div class="form-group">
            ...
            <springForm:input type="number" path="age" name="age" placeholder="Age..." cssClass="form-control" cssErrorClass="form-control errorbox" min="18" max="100" required="true"/>
